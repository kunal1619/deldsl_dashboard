  ...
  return (
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8  h-screen flex items-center justify-center">
        ...
        <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]">
                <span className='text-amber-500'>Sterlite</span> <span className='text-gray-600'>Escalation</span> 
              </h2>
    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr className="border-b border-gray-200 dark:border-gray-700">
                <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    amit.tripathi@sterlitepower.com
                </th>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    Majaz.ahmad@sterlitepower.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    mohd.rahman@sterlite.com 
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    Harish.Tripathi@sterlite.com 
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    chintan.maru@sterlite.com
                </td>
