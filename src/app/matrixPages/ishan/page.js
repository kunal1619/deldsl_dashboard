        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
          <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
            ...
            <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]">
              <span className="text-amber-500">Ishan</span>{" "}
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-300 dark:border-gray-700">
                <th
                  ...
                  className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800"
                >
                  Email : helpdesk@ishanitech.bizm <br></br>
                   0281-6647426
                </th>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email : soneji.ankit@ishanitech.biz <br></br>
                9687680331
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email : hasnain.nadir@ishanitech.biz <br></br>
                6358956791
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email : Yadav.pawan@ishanitech.biz <br></br>
                8980088971
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email : somani.devilal@ishanitech.biz  <br></br>
                9879612589
                </td>
              </tr>
            </tbody>
