  ...
  return (
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8  h-screen flex items-center justify-center">
        ...
        <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]">
                <span className='text-amber-500'>Ranext</span> <span className='text-gray-600'>Escalation</span> 
              </h2>
    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead className="text-xs text-gray-700 dark:text-gray-400">
            <tr>
                <th scope="col" className=" uppercase px-6 py-3 text-xl bg-gray-50 dark:bg-gray-800">
                    Level - 0
                </th>
                <th scope="col" className="px-6 py-3 text-xl bg-gray-50  uppercase">
                    Level - 1 <br></br>
                    <span className='text-sm font-normal lowercase'>After 1 hrs</span>
                </th>
                <th scope="col" className="px-6 py-3 text-xl bg-gray-50 dark:bg-gray-800  uppercase">
                    Level - 2 <br></br>
                    <span className='text-sm font-normal lowercase'>After 2 hrs</span> 
                </th>
                <th scope="col" className=" uppercase px-6 py-3 text-xl bg-gray-50 dark:bg-gray-800">
                    Level - 3
                </th>
        ...
        <tbody>
            <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    Ajay sharma(8800991103) <br></br>
                    email: ajay.sharma@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Jitendra Singh (9935099784)
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                After 3 hrs
                </td>
            ...
            <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Prakash kumar(8383932051) <br></br>
                    email: prakash.kumar@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email: Jitendra.Singh@Ranext.in 
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Sachin Holkar (7259110786)
                </td>
            ...
            <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                ...
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Ganesh shinde(7710038191) <br></br>
                    email: ganesh.shinde@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Sachin Holkar (7259110786)
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email: sachin.holkar@Ranext.in
                </td>
            ...
            <tr className="border-b border-gray-200 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                    Install - customerconnect@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Amit singh(9026737244) <br></br>
                    email: amit.singh@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Email: sachin.holkar@Ranext.in 
                </td>
            ...
            <tr className="border-b border-gray-200 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Fault - customercare@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Sachin holkar(7259110786) <br></br>
                email: sachin.holkar@Ranext.in
                </td>
                <td className="px-6 py-4 font-medium text-gray-700 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
